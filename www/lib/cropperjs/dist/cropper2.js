  ...
  Cropper.prototype = {
    ...
    limitCropBox: function (sizeLimited, positionLimited) {
      ...
      if (sizeLimited) {
        ...
        console.warn('cropBoxData: ', cropBoxData);
      }
    ...
    getCroppedCanvas: function (options) {
      ...
      context.drawImage.apply(context, (function () {
        ...
        if(dstWidth > dstHeight){
          dstY=(originalHeight - dstHeight)/2;
          dstX = 0;
        }else {
          dstY = 0;
          dstX=(originalWidth - dstWidth)/2;
        }
...
http://192.168.1.15/myfacegallery/cache/assets/19/fotos/2016/04/1460133230-400x400.png
